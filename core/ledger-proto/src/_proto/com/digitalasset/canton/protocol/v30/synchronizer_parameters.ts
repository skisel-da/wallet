...
class AcsCommitmentsCatchUpConfig$Type extends MessageType<AcsCommitmentsCatchUpConfig> {
    ...
    create(
        ...
        if (value !== undefined)
            reflectionMergePartial<AcsCommitmentsCatchUpConfig>(
                this,
                message,
                value
            )
...
class ParticipantSynchronizerLimits$Type extends MessageType<ParticipantSynchronizerLimits> {
    ...
    create(
        ...
        if (value !== undefined)
            reflectionMergePartial<ParticipantSynchronizerLimits>(
                this,
                message,
                value
            )
...
class DynamicSynchronizerParameters$Type extends MessageType<DynamicSynchronizerParameters> {
    ...
    create(
        ...
        if (value !== undefined)
            reflectionMergePartial<DynamicSynchronizerParameters>(
                this,
                message,
                value
            )
